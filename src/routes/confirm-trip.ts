        ...
        async (request, reply)=>{
            ...
            await Promise.all(
                trip.participant.map(async (participant) => {
                    ...
                    const confirmationLink = `${env.API_BASE_URL}/participants/${trip.id}/${participant.id}/confirm`
                    ...
                    const message = await mail.sendMail({
                        ...
                        html: `
                            ...
                            <p>Você foi convidado(a) para participar de uma viagem para <strong>${trip.destination}</strong> nas datas de <strong>${formatedStartDate}</strong> até <strong>${formatedEndDate}.</p>
                            <p></p>
